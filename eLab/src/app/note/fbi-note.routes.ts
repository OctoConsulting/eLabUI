...
export const routes: Routes = [
  {
    ...
    children : [
      ...
      { path : 'qdetails/new/:notedId/:examId/:parentId', component : QDetailsPage},
      { path : 'qdetails/view/:examId/:id', component : QDetailsPage},
      { path : 'shoe/kdetails/new/:notedId/:examId/:parentId', component : KDetailsPage},
      { path : 'shoe/kdetails/view/:examId/:id', component : KDetailsPage},
      { path : 'tire/kdetails/new/:notedId/:examId/:parentId', component : KDetailsPage},
